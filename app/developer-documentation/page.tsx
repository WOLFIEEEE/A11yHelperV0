  ...
  return (
    <div className="container py-12 md:py-24 lg:py-32">
      ...
      <p className="text-xl text-center mb-12 max-w-3xl mx-auto">
        Comprehensive documentation for A11yHelper components and their usage. Click on a component to view its detailed
        documentation.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {components.map((component) => (
          <Card key={component.slug}>
            ...
            <CardContent>
              <Link href={`/developer-documentation/${component.slug}`} className="text-primary hover:underline">
                View Documentation
              </Link>
            </CardContent>
          </Card>
